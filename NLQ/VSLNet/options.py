...
def read_command_line():
    ...
    parser.add_argument("--narration_filename", type=str, required=False, help="Path to the filtered narrations JSON file.")
    parser.add_argument("--output_dir", type=str, required=False, help="Path to save the generated query-answer pairs.")
    parser.add_argument(
        "--video_feature_dim",
        type=int,
        default=1024,
